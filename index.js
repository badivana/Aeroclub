...
// Static file serving (fixed missing path separator)
...
app.use(express.urlencoded({ extended: false })); // fixed: was string "false"
...
// Events sub-pages (events_vayu folder)
app.get("/aeroX", (req, res) => {
...
app.get("/wordsWithWings", (req, res) => {
